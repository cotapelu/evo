...
function updateFromEntries(cache, entries) {
...
export function installSessionStatsCache(api) {
...
export function getCacheForContext(ctx) {
    return contextCaches.get(ctx) ?? null;
}
//# sourceMappingURL=session-stats-cache.js.map