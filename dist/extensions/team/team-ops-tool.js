 ...
 */
export function createTeamOpsTool(team) {
    return {
        name: "team_ops",
        label: "Team Ops",
            ...
            try {
                switch (action) {
                    ...
                    case "workspace_read": {
                        const { key } = params;
                        if (!key) {
                            return { content: [{ type: "text", text: "Missing key" }], details: undefined, isError: true };
                        }
                    ...
                    case "workspace_write": {
                        ...
                        if (!key || value === undefined) {
                            return { content: [{ type: "text", text: "Missing key or value" }], details: undefined, isError: true };
                        }
                    ...
                    case "send_message": {
                        ...
                        if (!content) {
                            return { content: [{ type: "text", text: "Missing content" }], details: undefined, isError: true };
                        }
                    ...
                    case "update_status": {
                        const { status } = params;
                        if (!status) {
                            return { content: [{ type: "text", text: "Missing status" }], details: undefined, isError: true };
                        }
...
//# sourceMappingURL=team-ops-tool.js.map