export declare const CUSTOM_MODELS: {
    readonly kilo: {
        ...
        readonly "cohere/command-r7b-12-2024": {
            id: string;
            name: string;
            api: "openai-completions";
            provider: string;
        ...
        readonly "x-ai/grok-code-fast-1:optimized:free": {
            id: string;
            name: string;
            api: "openai-completions";
            provider: string;
...
//# sourceMappingURL=custom-models.generated.d.ts.map