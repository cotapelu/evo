 ...
 */
function renderGetTeamStatus(details, theme) {
...
function renderGetMessages(details, theme) {
...
function renderWorkspaceRead(details, theme) {
    const lines = [];
...
//# sourceMappingURL=team-ops-renderer.js.map