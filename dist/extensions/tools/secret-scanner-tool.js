...
async function shouldScanFile(filePath, extensions, exclude, maxSize) {
    const ext = "." + (filePath.split(".").pop() || "");
    if (!extensions.includes(ext))
        return false;
    if (exclude.some(dir => filePath.includes(dir)))
        return false;
    try {
...
export function registerSecretScannerTool(api) {
    const tool = {
        name: "secret_scanner",
...
//# sourceMappingURL=secret-scanner-tool.js.map