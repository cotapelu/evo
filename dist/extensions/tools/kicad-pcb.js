...
// Tool Factory
// ============================================================================
export function createKicadPcbTool() {
    return {
        name: "kicad_pcb",
        label: "KiCad PCB",
        ...
        async execute(_toolCallId, params, signal, _onUpdate, ctx) {
            ...
            try {
                ...
                return { content: [{ type: "text", text: `kicad_pcb ${command} error: ${error.message}` }], details: null, isError: true };
            }
        }
    };
}
export function registerKicadPcbTool(api) {
    api.registerTool(createKicadPcbTool());
}
//# sourceMappingURL=kicad-pcb.js.map