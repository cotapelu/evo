...
describe('Auto-Continue Extension', () => {
    ...
    describe('initialization', () => {
        it('should register /gnpi command', () => {
            ...
            expect(mockPi.registerCommand).toHaveBeenCalledWith('gnpi', expect.objectContaining({
    ...
    describe('command handler', () => {
        ...
        it('should enable and notify when called with "on"', async () => {
            ...
            expect(mockCtx.ui.notify).toHaveBeenCalledWith(expect.stringContaining('Auto-continue enabled'), 'info');
        });
        it('should set timeout and notify when given a number', async () => {
            await handler('60', mockCtx);
            expect(mockCtx.ui.notify).toHaveBeenCalledWith('Auto-continue timeout set to 60 seconds', 'info');
        });
