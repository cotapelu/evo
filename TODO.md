...
- [x] Fixed Jest ESM coverage collection (transformIgnorePatterns) for accurate measurement (R34)
- [x] Fixed Jest ESM coverage collection (transformIgnorePatterns) for accurate measurement (R34)
- [x] Added comprehensive tests for metrics collector (7 tests, 97%+ coverage) (R34)
