...
✅ Iteration 147 (latest) — refactored plugin-loader.unloadAll: extracted clearAllTimers, unloadAllPlugins, closeAllWatchers; unloadAll now 4 lines, all helpers ≤20 lines. All tests passing.
