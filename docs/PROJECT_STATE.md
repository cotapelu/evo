...
✅ Iteration 137 (latest) — refactored dependency_tree: split handleExportNamedDeclaration into processDeclaration, processExportSpecifiers, processReimport; extracted processFileImports from resolveImports; extracted bfs from computeReachable; all functions now ≤20 lines. All tests passing.
