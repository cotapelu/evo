...
function generateToolTestTemplate(name: string): string {
...
function generateProviderTemplate(name: string, description: string): string {
  const pascalName = toPascalCase(name);
...
function generateProviderTestTemplate(name: string): string {
  const pascalName = toPascalCase(name);
...
function generateHookTemplate(name: string, description: string): string {
  const pascalName = toPascalCase(name);
...
function createTemplateGeneratorTool(): ToolDefinition<any, any> {
  return {
...
export function registerExtensionTemplateGeneratorTool(api: ExtensionAPI): void {
