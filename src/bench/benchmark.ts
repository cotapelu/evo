...
class BenchmarkRunner {
  ...
  async measure(name: string, fn: () => Promise<any> | any, iterations: number = 10): Promise<void> {
    const times: number[] = [];
...
async function benchPatternScanning(runner: BenchmarkRunner): Promise<void> {
...
async function benchFileRead(runner: BenchmarkRunner): Promise<void> {
...
async function benchPatternCheck(runner: BenchmarkRunner): Promise<void> {
...
async function benchAllPatterns(runner: BenchmarkRunner): Promise<void> {
