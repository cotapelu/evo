...
// Iteration 100: 3 changes (Refactor for modularity) [critical]
// Iteration 99: 3 changes (Refactor for modularity) [critical]
// Iteration 98: 3 changes (Refactor for modularity) [critical]
// Iteration 97: 3 changes (Refactor for modularity) [critical]
// Iteration 96: 3 changes (Refactor for modularity) [critical]
// Iteration 95: 3 changes (Refactor for modularity) [critical]
// Iteration 94: 3 changes (Refactor for modularity) [critical]
// Iteration 93: 3 changes (Refactor for modularity) [critical]
// Iteration 92: 3 changes (Refactor for modularity) [critical]
// Iteration 91: 3 changes (Refactor for modularity) [critical]
// Iteration 90: 3 changes (Refactor for modularity) [critical]
// Iteration 89: 3 changes (Refactor for modularity) [critical]
// Iteration 88: 3 changes (Refactor for modularity) [critical]
// Iteration 87: 3 changes (Refactor for modularity) [critical]
// Iteration 86: 3 changes (Refactor for modularity) [critical]
// Iteration 85: 3 changes (Refactor for modularity) [critical]
// Iteration 84: 3 changes (Refactor for modularity) [critical]
// Iteration 83: 3 changes (Refactor for modularity) [critical]
// Iteration 82: 3 changes (Refactor for modularity) [critical]
// Iteration 81: 3 changes (Refactor for modularity) [critical]
// Iteration 80: 3 changes (Refactor for modularity) [critical]
// Iteration 79: 3 changes (Refactor for modularity) [critical]
// Iteration 78: 3 changes (Refactor for modularity) [critical]
// Iteration 77: 3 changes (Refactor for modularity) [critical]
// Iteration 76: 3 changes (Refactor for modularity) [critical]
// Iteration 75: 3 changes (Refactor for modularity) [critical]
// Iteration 74: 3 changes (Refactor for modularity) [critical]
// Iteration 73: 3 changes (Refactor for modularity) [critical]
// Iteration 72: 3 changes (Refactor for modularity) [critical]
// Iteration 71: 3 changes (Refactor for modularity) [critical]
// Iteration 70: 3 changes (Refactor for modularity) [critical]
// Iteration 69: 3 changes (Refactor for modularity) [critical]
// Iteration 68: 3 changes (Refactor for modularity) [critical]
// Iteration 67: 3 changes (Refactor for modularity) [critical]
// Iteration 66: 3 changes (Refactor for modularity) [critical]
// Iteration 65: 3 changes (Refactor for modularity) [critical]
// Iteration 64: 3 changes (Refactor for modularity) [critical]
// Iteration 63: 3 changes (Refactor for modularity) [critical]
// Iteration 62: 3 changes (Refactor for modularity) [critical]
// Iteration 61: 3 changes (Refactor for modularity) [critical]
// Iteration 60: 3 changes (Refactor for modularity) [critical]
// Iteration 59: 3 changes (Refactor for modularity) [critical]
// Iteration 58: 3 changes (Refactor for modularity) [critical]
// Iteration 57: 3 changes (Refactor for modularity) [critical]
// Iteration 56: 3 changes (Refactor for modularity) [critical]
// Iteration 55: 3 changes (Refactor for modularity) [critical]
// Iteration 54: 3 changes (Refactor for modularity) [critical]
// Iteration 53: 3 changes (Refactor for modularity) [critical]
// Iteration 52: 3 changes (Refactor for modularity) [critical]
// Iteration 51: 3 changes (Refactor for modularity) [critical]
// Iteration 50: 3 changes (Refactor for modularity) [critical]
// Iteration 49: 3 changes (Refactor for modularity) [critical]
// Iteration 48: 3 changes (Refactor for modularity) [critical]
// Iteration 47: 3 changes (Refactor for modularity) [critical]
// Iteration 46: 3 changes (Refactor for modularity) [critical]
// Iteration 45: 3 changes (Refactor for modularity) [critical]
// Iteration 44: 3 changes (Refactor for modularity) [critical]
// Iteration 43: 3 changes (Refactor for modularity) [critical]
// Iteration 42: 3 changes (Refactor for modularity) [critical]
// Iteration 41: 3 changes (Refactor for modularity) [critical]
// Iteration 40: 3 changes (Refactor for modularity) [critical]
// Iteration 39: 3 changes (Refactor for modularity) [critical]
// Iteration 38: 3 changes (Refactor for modularity) [critical]
// Iteration 37: 3 changes (Refactor for modularity) [critical]
// Iteration 36: 3 changes (Refactor for modularity) [critical]
// Iteration 35: 3 changes (Refactor for modularity) [critical]
// Iteration 34: 3 changes (Refactor for modularity) [critical]
// Iteration 33: 3 changes (Refactor for modularity) [critical]
// Iteration 32: 3 changes (Refactor for modularity) [critical]
// Iteration 31: 3 changes (Refactor for modularity) [critical]
// Iteration 30: 3 changes (Refactor for modularity) [critical]
// Iteration 29: 3 changes (Refactor for modularity) [critical]
// Iteration 28: 3 changes (Refactor for modularity) [critical]
// Iteration 27: 3 changes (Refactor for modularity) [critical]
// Iteration 26: 3 changes (Refactor for modularity) [critical]
// Iteration 25: 3 changes (Refactor for modularity) [critical]
// Iteration 24: 3 changes (Refactor for modularity) [critical]
// Iteration 23: 3 changes (Refactor for modularity) [critical]
// Iteration 22: 3 changes (Refactor for modularity) [critical]
...
export class EvoAgent {
  ...
  constructor(config: Partial<AgentConfig> = {}, parent?: EvoAgent) {
    ...
    this.config = {
      ...
      resourceLimits: {
        maxMemoryMB: parseInt(process.env.AGENT_RESOURCE_MAX_MEMORY || '500'),
  ...
  private async expandCapabilities(): Promise<void> {
    const current = this.state.capabilities.map(c => c.toLowerCase().replace(/[^a-z]/g, ''));
    const candidates = [
      'deployment', 'worker-pool', 'ast-transformation', 'orchestration', 'performance-tuning',
      'auto-recovery', 'distributed-coordination', 'caching', 'load-balancing', 'monitoring', 'plugin-system', 'event-driven', 'metrics-collection', 'dynamic-reconfiguration'
    ];
    
    for (const cap of candidates) {
      const normalized = cap.toLowerCase().replace(/[^a-z]/g, '');
      if (current.includes(normalized)) continue;
      // Check level requirement
      const req = this.getCapabilityLevelRequirement(cap);
      if (this.state.level < req) continue;
      const displayName = this.formatCapabilityName(cap);
      this.state.capabilities.push(displayName);
      this.log('info', '🎁 Unlocked capability:', displayName);
    }
  }

  private formatCapabilityName(cap: string): string {
    // Convert 'worker-pool' -> 'worker-pool'
  ...
  private async executeIteration(): Promise<void> {
    ...
    if (this.config.deploy?.autoDeployOnStable && this.state.level >= 25 && this.iterationCount % 10 === 0) {
      ...
      // Expand capabilities via level-based unlocking
  ...
  async deploy(version?: string): Promise<{ success: boolean; message: string; files: string[] }> {
    ...
    try {
      ...
      // Auto-create build artifacts if missing
      if (!fs.existsSync('build.sh')) {
        try { await this.createBuildScript(); } catch (e) { this.log('warn', 'Build script creation failed:', e); }
      }
      if (!fs.existsSync('package.json')) {
        try { await this.createPackageJson(); } catch (e) { this.log('warn', 'Package.json creation failed:', e); }
      }
